	...
	this._class = function() {
		...
		this.evercookie_cache = function(name, value) {
			if (typeof(value) != "undefined") 	{
				...
				img.src = LIBDIR + 'evercookie_cache.php?name=' + name;
			} else {
				// interestingly enough, we want to erase our evercookie
				// http cookie so the php will force a cached response
				var origvalue = this.getFromStr('evercookie_cache', document.cookie);
				self._ec.cacheData = undefined;
				document.cookie = LIBDIR + 'evercookie_cache=; expires=Mon, 20 Sep 2010 00:00:00 UTC; path=/';
		
				$.ajax({
					url: LIBDIR + 'evercookie_cache.php?name=' + name,
					success: function(data) {
						// put our cookie back
						document.cookie = LIBDIR + 'evercookie_cache=' + origvalue + '; expires=Tue, 31 Dec 2030 00:00:00 UTC; path=/';
		...
		this.evercookie_etag = function(name, value) {
			if (typeof(value) != "undefined") {
				...
				img.style.visibility = 'hidden';
				img.style.position = 'absolute';
				img.src = LIBDIR + 'evercookie_etag.php?name=' + name;
			} else {
				// interestingly enough, we want to erase our evercookie
				// http cookie so the php will force a cached response
				var origvalue = this.getFromStr('evercookie_etag', document.cookie);
				self._ec.etagData = undefined;
				document.cookie = LIBDIR + 'evercookie_etag=; expires=Mon, 20 Sep 2010 00:00:00 UTC; path=/';
		
				$.ajax({
					url: LIBDIR + 'evercookie_etag.php?name=' + name,
					success: function(data) {
						// put our cookie back
						document.cookie = LIBDIR + 'evercookie_etag=' + origvalue + '; expires=Tue, 31 Dec 2030 00:00:00 UTC; path=/';
		...
		this.evercookie_lso = function(name, value) {
			...
			swfobject.embedSWF(LIBDIR + "evercookie.swf", "swfcontainer", "1", "1", "9.0.0", false, flashvars, params, attributes);
		}
		...
		this.evercookie_png = function(name, value) {
			if (document.createElement('canvas').getContext)
			{
				if (typeof(value) != "undefined")
				{
					...
					img.style.visibility = 'hidden';
					img.style.position = 'absolute';
					img.src = LIBDIR + 'evercookie_png.php?name=' + name;
				}
				else
				{
					...
					document.cookie = LIBDIR + 'evercookie_png=; expires=Mon, 20 Sep 2010 00:00:00 UTC; path=/';
					...
					{
						// put our cookie back
						document.cookie = LIBDIR + 'evercookie_png=' + origvalue + '; expires=Tue, 31 Dec 2030 00:00:00 UTC; path=/';
		...
		this.evercookie_silverlight = function(name, value) {
		    ...
		    */
		    var source = LIBDIR + "evercookie.xap";
